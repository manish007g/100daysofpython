...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.canvas_text = self.canvas.create_text(150, 125, width=280, text="HELLO", fill=THEME_COLOR)
        self.canvas.grid(row=1, column=0, columnspan=2, pady=50)

        self.score_label = Label(text=f"score: 0", font=(FONT_NAME, 10), fg="white", bg=THEME_COLOR)
